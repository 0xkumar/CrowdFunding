...
contract FundMe {
    ...
    // function changeinstance() public {
    //     test_address= AggregatorV3Interface(priceFeed);
    // }
    ...
    function getAddressOfTheFunderByIndex(uint _index) external view returns(address){
